        ...
        try {
          ...
          if (fp.file) {
            ...
            gLastOpenDirectory.path =
              fp.file.parent.QueryInterface(Components.interfaces.nsIFile);
          }
        } catch (ex) {
        }
...
function BrowserUploadFile()
{
  ...
  fp.open(rv => {
    ...
    gLastOpenUploadDirectory.path = fp.file.parent.QueryInterface(Components.interfaces.nsIFile);
    ...
    try {
      ...
      var leafName = fp.fileURL.QueryInterface(Components.interfaces.nsIFileURL).file.leafName;
