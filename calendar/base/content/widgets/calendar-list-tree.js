...
// Wrap in a block to prevent leaking to window scope.
{
    ...
    class CalendarListTree extends customElements.get("tree") {
        ...
        connectedCallback() {
            ...
            this.compositeObserver = {
                listTree: this,
                QueryInterface: XPCOMUtils.generateQI([Ci.calICompositeObserver]),
        ...
        foreignDrop(event) {
            const hasDropped = event.clientY < this.tree.boxObject.y
    ...
    class CalendarListTreeFull extends CalendarListTree {
        connectedCallback() {
            ...
            this.compositeObserver = {
                listTree: this,
                QueryInterface: XPCOMUtils.generateQI([Ci.calICompositeObserver, Ci.calIObserver]),
