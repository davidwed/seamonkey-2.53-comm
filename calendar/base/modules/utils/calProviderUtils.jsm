...
var calprovider = {
    ...
    createStreamLoader: function() {
        return Cc["@mozilla.org/network/stream-loader;1"]
    ...
    BadCertHandler: class {
        QueryInterface(iid) {
            return cal.generateClassQI(this, iid, [Ci.nsIBadCertListener2]);
        }
    ...
    FreeBusyInterval: class {
        QueryInterface(iid) {
            return cal.generateClassQI(this, iid, [Ci.calIFreeBusyInterval]);
        }
