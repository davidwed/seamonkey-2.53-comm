...
const kNormalStyleSheet = "chrome://messenger/content/messengercompose/EditorContent.css";
const kAllTagsStyleSheet = "chrome://messenger/content/messengercompose/EditorAllTags.css";
...
function EditorSelectColor(colorType, mouseEvent)
{
  ...
  if (!useLastColor)
  {
    ...
    window.openDialog("chrome://messenger/content/messengercompose/EdColorPicker.xul", "_blank", "chrome,close,titlebar,modal", "", gColorObj);
...
function EditorInsertOrEditTable(insertAllowed)
{
  if (IsInTable())
  {
    ...
    window.openDialog("chrome://messenger/content/messengercompose/EdTableProps.xul", "_blank", "chrome,close,titlebar,modal", "","TablePanel");
    gContentWindow.focus();
  } 
...
{
  // Insert a new table
  window.openDialog("chrome://messenger/content/messengercompose/EdInsertTable.xul", "_blank", "chrome,close,titlebar,modal", "");
  gContentWindow.focus();
}
...
function EditorTableCellProperties()
{
  ...
  try {
    ...
    if (cell) {
      ...
      window.openDialog("chrome://messenger/content/messengercompose/EdTableProps.xul", "_blank", "chrome,close,titlebar,modal", "", "CellPanel");
      gContentWindow.focus();
    }
  } catch (e) {}
}
...
function EditorFindOrCreateInsertCharWindow()
{
  ...
  else
  {
    ...
    else
    {
      ...
      window.openDialog("chrome://messenger/content/messengercompose/EdInsertChars.xul", "_blank", "chrome,close,titlebar", "");
    }
  }
}
...
function UpdateTOC()
{
  window.openDialog("chrome://messenger/content/messengercompose/EdInsertTOC.xul",
