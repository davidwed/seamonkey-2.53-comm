...
function Publish(publishData)
{
  ...
  try {
    ...
    gProgressDialog =
      window.openDialog("chrome://messenger/content/messengercompose/EditorPublishProgress.xul", "_blank",
...
var nsFindReplaceCommand =
{
  ...
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdReplace.xul", "_blank",
...
var nsImageCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdImageProps.xul","_blank", "chrome,close,titlebar,modal");
  }
};
...
var nsHLineCommand =
{
  ...
  doCommand: function(aCommand)
  {
    ...
    if (hLine)
    {
      ...
      window.openDialog("chrome://messenger/content/messengercompose/EdHLineProps.xul", "_blank", "chrome,close,titlebar,modal");
    }
    else
    {
      try {
...
var nsLinkCommand =
{
  ...
  doCommand: function(aCommand)
  {
    ...
    if (element && element.nodeName.toLowerCase() == "img")
      window.openDialog("chrome://messenger/content/messengercompose/EdImageProps.xul", "_blank", "chrome,close,titlebar,modal", null, true);
    else
      window.openDialog("chrome://messenger/content/messengercompose/EdLinkProps.xul", "_blank", "chrome,close,titlebar,modal");
  }
};
...
var nsAnchorCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdNamedAnchorProps.xul", "_blank", "chrome,close,titlebar,modal", "");
  }
};
...
var nsInsertHTMLWithDialogCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdInsSrc.xul", "_blank", "chrome,close,titlebar,modal,resizable", "");
  }
};
...
var nsInsertMathWithDialogCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdInsertMath.xul", "_blank", "chrome,close,titlebar,modal,resizable", "");
  }
};
...
var nsListPropertiesCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdListProps.xul", "_blank", "chrome,close,titlebar,modal");
  }
};
...
function doAdvancedProperties(element)
{
  if (element)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdAdvancedEdit.xul", "_blank", "chrome,close,titlebar,modal,resizable=yes", "", element);
  }
}
...
var nsColorPropertiesCommand =
{
  ...
  doCommand: function(aCommand)
  {
    window.openDialog("chrome://messenger/content/messengercompose/EdColorProps.xul", "_blank", "chrome,close,titlebar,modal", "");
    UpdateDefaultColors();
  }
};
...
var nsConvertToTable =
{
  ...
  doCommand: function(aCommand)
  {
    ...
    {
      window.openDialog("chrome://messenger/content/messengercompose/EdConvertToTable.xul", "_blank", "chrome,close,titlebar,modal")
    }
  }
};
